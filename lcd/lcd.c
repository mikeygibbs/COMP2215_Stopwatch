...
void clear_top()
{
    ...
    rectangle r = {0, display.width-1, 0, display.height-1};
    fill_rectangle(r, display.background);
    rectangle l ={0, display.width-1, 20, 20};
...
void clear_bottom()
{
    display.x = 0;
    display.y = 22;
    rectangle r = {0, display.width-1, 22, display.height-1};
    fill_rectangle(r, display.background);
    display.x = (display.width / 2) - 90; 
    display.y = 24;
    display_string("Lap");
    display.x = (display.width / 2) - 16;
    display_string("Time");
    display.x = (display.width / 2) + 58;
    display_string("Split");
    rectangle l ={0, display.width-1, 40, 40};
    fill_rectangle(l, WHITE);
    display.y = 42;
}
